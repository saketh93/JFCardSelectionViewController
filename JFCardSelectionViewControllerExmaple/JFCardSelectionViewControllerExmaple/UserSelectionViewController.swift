...
class UserSelectionViewController: JFCardSelectionViewController {
    ...
    let cards = [
        ...
        User(name: "Jim Brown", photoURL: "http://www.geek.com/wp-content/uploads/2010/07/Scott-Forstall-Executive-profile-image.jpg", address: "234 Main St", city: "Atlanta", state: "GA", zip: 12345),
        User(name: "Jane Daughtry", photoURL: "http://fuerteventura-surf.com/assets/img/homeGuestHostImages/client(3).jpg", address: "345 Main St", city: "Atlanta", state: "GA", zip: 12345),
        User(name: "Avery James", photoURL: "http://thumbs.dreamstime.com/z/profile-face-young-woman-isolated-white-background-38923522.jpg", address: "456 Main St", city: "Atlanta", state: "GA", zip: 12345),
        User(name: "Jamar Michaels", photoURL: "https://s3.amazonaws.com/um-profile-pics/1/profile_half.JPG?1348755125", address: "567 Main St", city: "Atlanta", state: "GA", zip: 12345),
